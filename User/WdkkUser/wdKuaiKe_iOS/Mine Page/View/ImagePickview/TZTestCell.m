...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        [_deleteBtn setBackgroundImage:[UIImage imageNamed:@"叉"] forState:UIControlStateNormal];
...
- (void)layoutSubviews {
    ...
    _deleteBtn.sd_layout.rightEqualToView(self).topEqualToView(self).widthIs(20).heightIs(20);
}
