...
//    [self.payButton setTitle:[NSString stringWithFormat:@"还差￥%ld",(unsigned long)self.minFreeMoney] forState:UIControlStateNormal];
        [self.payButton setTitle:[NSString stringWithFormat:@"预约"] forState:UIControlStateNormal];
    ...
    [self.shoppingCartBtn setImage:[UIImage imageNamed:@"canju"] forState:UIControlStateNormal];
    self.shoppingCartBtn.frame = CGRectMake(10, -10, 50,50);
    [self.shoppingCartBtn setBackgroundColor:[UIColor grayColor]];
    ...
    self.shoppingCartBtn.layer.cornerRadius = _shoppingCartBtn.size.width / 2;
    self.shoppingCartBtn.layer.masksToBounds = YES;
...
//    [[self viewController].navigationController pushViewController:newOrderVC animated:YES];
//}
