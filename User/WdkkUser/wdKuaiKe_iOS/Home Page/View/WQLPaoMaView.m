...
- (instancetype)initWithFrame:(CGRect)frame withTitle:(NSString *)title
{
    ...
    if (self) {
        ...
        myLable.backgroundColor = [UIColor lightGrayColor];
        myLable.text = title;
        myLable.font = [UIFont systemFontOfSize:13.0f];
        
        //计算文本的宽度
        CGFloat calcuWidth = [self widthForTextString:title height:labelHeight fontSize:13.0f];
        ...
        if (calcuWidth>frame.size.width) {
            ...
            behindLabel.backgroundColor = [UIColor lightGrayColor];
