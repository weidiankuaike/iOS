...
#define kTencentAppId   @"1105647682"

#define kWeixinAppId    @"wx456660a0c14036a6"
#define kWeixinAppSecret @"cbf84e0bb7d104ef53367e42aa9bbb24"


@interface WTThirdPartyLoginManager () <NSCopying,NSURLSessionTaskDelegate, WeiboSDKDelegate>
...
- (void)getWeiXinUserInfoWithCode:(NSString *)code
{
    ...
    NSBlockOperation * getUserInfoOperation = [NSBlockOperation blockOperationWithBlock:^{
        ...
        NSDictionary *dic = [NSJSONSerialization JSONObjectWithData:responseData options:kNilOptions error:nil];
        NSLog(@"<><>????????%@",dic);
        NSDictionary *paramter = @{@"third_id" : dic[@"unionid"],
