...
//加密解密的key,与后台一致
#define USER_KEY @"020907190126110910150109"
//初始化向量，与后台一致
#define initIv    @"09160928"

@implementation ZT3DesSecurity
+ (NSString *)encryptWithText:(NSString *)sText
{
    sText = [sText deleteTabOrSpaceStr];
//    NSString *str = [self encrypt:sText encryptOrDecrypt:kCCEncrypt key:USER_KEY];
//    //kCCEncrypt 加密
