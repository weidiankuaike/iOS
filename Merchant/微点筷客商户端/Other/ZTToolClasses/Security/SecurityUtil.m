...
#define Iv          @"09160928" //偏移量,可自行修改
#define KEY         @"020907190126110910150109" //key，可自行修改
...
+(NSString*)encryptAESData:(NSString*)string
{
    ...
    return [[self encodeBase64Data:encryptedData] stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet characterSetWithCharactersInString:@"#%<>[\\]^`{|}+"].invertedSet];
}
