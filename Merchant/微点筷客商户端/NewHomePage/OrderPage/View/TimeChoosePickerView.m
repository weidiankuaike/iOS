...
#import "TimeChoosePickerView.h"

@implementation TimeChoosePickerView
{
    //    row
    NSInteger left0_row;
    NSInteger left1_row;
...
-(void)createUI{
    ...
    white_view.frame = CGRectMake(0, 0, kScreenWidth-autoScaleW(85), autoScaleH(130));
    ...
    title_label=[[UILabel alloc]initWithFrame:XMRECT6(CGRectMake((275-110)/2, 21, 150, 30))];
    
    title_label.text=@"繁忙状态开始时间";
...
//    for (int i=0; i<2; i++) {
//        
//        ButtonStyle * choose=[[ButtonStyle alloc]initWithFrame:XMRECT6(CGRectMake(70+116*i, 60, 100, 30))];
//        
