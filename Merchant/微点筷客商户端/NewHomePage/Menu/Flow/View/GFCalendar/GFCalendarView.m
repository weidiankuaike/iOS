...
@property (nonatomic, strong) ButtonStyle *calendarHeaderButton;
...
- (instancetype)initWithFrameOrigin:(CGPoint)origin width:(CGFloat)width type:(NSInteger)typeInt{
    ...
    if (self = [super initWithFrame:CGRectMake(origin.x, origin.y, width, _calendarHeight)]) {
        ...
        _calendarScrollView.typeint = typeInt;
...
- (ButtonStyle *)setupCalendarHeaderButtonWithFrame:(CGRect)frame {
...
- (void)refreshToCurrentMonthAction:(ButtonStyle *)sender {
