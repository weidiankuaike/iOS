...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.xiaoflabel.font = [UIFont systemFontOfSize:13];
        self.xiaoflabel.textColor = UIColorFromRGB(0x717171);
        [self addSubview:self.xiaoflabel];
        self.xiaoflabel.sd_layout.leftSpaceToView(self,autoScaleW(15)).topSpaceToView(self,autoScaleH(15)).heightIs(autoScaleH(15));
        [self.xiaoflabel setSingleLineAutoResizeWithMaxWidth:210];
        ...
        self.yuelabel.sd_layout.leftSpaceToView(self,autoScaleW(15)).topSpaceToView(self.xiaoflabel,autoScaleH(8)).heightIs(autoScaleH(12));
        [self.yuelabel setSingleLineAutoResizeWithMaxWidth:200];
        ...
        self.timelabel.sd_layout.rightSpaceToView(self,autoScaleW(15)).topSpaceToView(self,autoScaleH(15)).widthIs(autoScaleW(80)).heightIs(autoScaleH(11));
        
        self.jiagelabel = [[UILabel alloc]init];
        self.jiagelabel.font = [UIFont systemFontOfSize:13];
