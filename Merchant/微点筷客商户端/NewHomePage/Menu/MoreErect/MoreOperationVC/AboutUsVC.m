...
- (void)setUp{
    ...
    imageV.image = [UIImage imageNamed:@"logo_icon"];
    [self.view addSubview:imageV];

    UILabel *versionLabel = [[UILabel alloc] init];

    versionLabel.text = wdkkVersion;
...
//
//
//    ButtonStyle *protocolBT = [ButtonStyle buttonWithType:UIButtonTypeCustom];
...
//
//    ButtonStyle *responsebilityBT = [ButtonStyle buttonWithType:UIButtonTypeCustom];
...
//    [self.view addSubview:responsebilityBT];
    ...
    ButtonStyle *commpanyBT = [ButtonStyle buttonWithType:UIButtonTypeCustom];
...
//    [commpanyBT addTarget:self action:@selector(responseClick:) forControlEvents:UIControlEventTouchUpInside];
    ...
    ButtonStyle *powerBT = [ButtonStyle buttonWithType:UIButtonTypeCustom];
...
//- (void)protocolClick:(ButtonStyle *)sender{
